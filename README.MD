...
```bash
sudo pacman -Sy --needed river waybar foot rofi-wayland mako grim slurp satty brightnessctl pamixer jq xorg-xwayland fuzzel ttf-font-awesome ttf-nerd-fonts-symbols-common xdg-desktop-portal xdg-desktop-portal-gtk
yay -S wbg
```
